...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchProfiles = async () => {
            ...
            try {
                // Use centralized API instance for fetching profiles
                const response = await api.get('/api/profiles/check-profiles', {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            // Use centralized API instance for creating profiles
            const response = await api.post('/api/profiles/create-profile', profileDetails, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
